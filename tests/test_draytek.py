...
class TestDraytek(unittest.TestCase):
    def test_empty(self):
        ...
        self.assertEqual("", default.browsername)
        self.assertFalse(default.headless)
        # self.assertEqual(None, default.url)  # No point testing url construction here
    ...
    def test_valid(self):
        ...
        self.assertEqual("Chrome", valid.browsername)
        self.assertTrue(valid.headless)
    ...
    @patch("draytekwebadmin.draytek.unload_driver", autospec=True)
    def test_close_session(self, mock_unload_driver):
        self._driver = True
        self.driver = True
        DrayTekWebAdmin.close_session(self)
        self.assertTrue(mock_unload_driver.called)
