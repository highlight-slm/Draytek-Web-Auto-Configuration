...
class TestUtils(unittest.TestCase):
    ...
    def test_boolOrNone(self):
        self.assertEqual(None, bool_or_none(None))
        self.assertEqual(True, bool_or_none(True))
        self.assertEqual(False, bool_or_none(False))
        self.assertEqual(True, bool_or_none(1))
        self.assertEqual(False, bool_or_none(0))
        self.assertEqual(True, bool_or_none("1"))
        self.assertEqual(True, bool_or_none("True"))
        self.assertEqual(False, bool_or_none("False"))
        self.assertEqual(False, bool_or_none(3))
